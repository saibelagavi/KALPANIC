    ...
    <div>
      <div className="mb-8">
        ...
        <p style={{ color: 'var(--color-text-2)', fontSize: '0.95rem' }}>
          Sign in to continue creating extraordinary playbooks.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label
            htmlFor="email"
            style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.875rem', color: 'var(--color-text-2)', fontWeight: 500 }}
          >
            Email
          </label>
          <input
        ...
        <button
          ...
          onMouseEnter={(e) => { if (!loading) (e.target as HTMLButtonElement).style.background = 'var(--color-accent-2)'; }}
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', margin: '1.5rem 0' }}>
        ...
        <span style={{ color: 'var(--color-text-3)', fontSize: '0.75rem' }}>or</span>
        <div style={{ flex: 1, height: '1px', background: 'var(--color-border)' }} />
      </div>
      ...
      <p style={{ marginTop: '2rem', textAlign: 'center', color: 'var(--color-text-2)', fontSize: '0.875rem' }}>
        ...
        <Link href="/sign-up" style={{ color: 'var(--color-accent)', textDecoration: 'none', fontWeight: 500 }}>
          Start for free
        </Link>
      </p>
    </div>
